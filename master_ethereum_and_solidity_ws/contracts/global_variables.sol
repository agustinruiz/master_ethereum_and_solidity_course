...
contract GlobalVars{
    ...
    // Una forma de saber cuanto gas consume la ejecucion de una funcion es la siguiente.
    // NOTA: esto no tiene en cuenta el costo constante de una transaccion que es aproximadamente 21000 wei
